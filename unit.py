...
class Unit():
    ...
    def update_green_case(self,player_units,enemy_units): # méthode permettant de mettre à jour les cases de déplacement
        ...
        # Initialisation
         ...
         # A METTRE DANS LE MAINNNNNNNNNNNNN__________________________________________________________________________________________
    ...
    def draw_health_bar(self, screen, health): # méthode permettant l'affichage de la barre de vie
        RED = (255, 0, 0)
        BLACK = (0, 0, 0)
        bar_length = 32 # Longueur de la barre
