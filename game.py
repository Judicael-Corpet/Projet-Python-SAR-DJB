...
class Game:
    ...
    def flip_display(self):
        ...
        # fond= pygame.image.load('mars.jpeg')
        # fond = pygame.transform.scale(fond, (1220, 700))
...
def main():
    ...
    player2 = Unit(game.Choix_Personnages_2.game_personnage, 15, 10, [32,32], game)
    ...
    player3 = Unit(game.Choix_Personnages_3.game_personnage, 15, 15, [32,32], game)
    ...
    player4 = Unit(game.Choix_Personnages_4.game_personnage, 15, 17, [32,32], game)
